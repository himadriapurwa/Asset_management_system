...
@Component({
  selector: 'app-assetmanagerdashboard',
  templateUrl: './assetmanagerdashboard.component.html',
  styleUrls: ['./assetmanagerdashboard.component.css']
})
export class AssetmanagerdashboardComponent implements OnInit {
