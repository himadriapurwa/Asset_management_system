...
@Component({
  selector: 'app-asset-alloc-charts',
  templateUrl: './asset-alloc-charts.component.html',
  styleUrls: ['./asset-alloc-charts.component.css']
})
export class AssetAllocChartsComponent implements OnInit {
